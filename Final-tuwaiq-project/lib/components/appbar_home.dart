...
HomeAppBar() {
  if (box.hasData("thePatient")) {
    final patientData = box.read("thePatient");
    patientobj = Patient.fromJson(patientData);
    print("%%%%%%appbar ${patientData.runtimeType}");
        ...
        children: [
          ...
          Expanded(
            ...
            child: Padding(
              ...
              child: Text(
                ' Welcome ' + (patientobj.patientName ?? ""),
